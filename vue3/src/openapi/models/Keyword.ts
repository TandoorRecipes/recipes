...
export function KeywordToJSONTyped(value?: Omit<Keyword, 'label'|'parent'|'numchild'|'numrecipe'|'created_at'|'updated_at'|'full_name'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
