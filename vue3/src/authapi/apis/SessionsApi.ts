...
import {
    type AllauthClientV1AuthSessionsGet200Response,
    AllauthClientV1AuthSessionsGet200ResponseFromJSON,
    AllauthClientV1AuthSessionsGet200ResponseToJSON,
} from '../models/AllauthClientV1AuthSessionsGet200Response';
import {
...
export class SessionsApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for allauthClientV1AuthSessionsDelete without sending the request
     */
    async allauthClientV1AuthSessionsDeleteRequestOpts(requestParameters: AllauthClientV1AuthSessionsDeleteRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/_allauth/{client}/v1/auth/sessions`;
    ...
    async allauthClientV1AuthSessionsDeleteRaw(requestParameters: AllauthClientV1AuthSessionsDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AuthSessionsGet200Response>> {
        const requestOptions = await this.allauthClientV1AuthSessionsDeleteRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for allauthClientV1AuthSessionsGet without sending the request
     */
    async allauthClientV1AuthSessionsGetRequestOpts(requestParameters: AllauthClientV1AuthSessionsGetRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
    ...
    async allauthClientV1AuthSessionsGetRaw(requestParameters: AllauthClientV1AuthSessionsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AuthSessionsGet200Response>> {
        const requestOptions = await this.allauthClientV1AuthSessionsGetRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
