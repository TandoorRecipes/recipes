...
import {
    type AllauthClientV1AuthWebauthnAuthenticateGet200Response,
    AllauthClientV1AuthWebauthnAuthenticateGet200ResponseFromJSON,
    AllauthClientV1AuthWebauthnAuthenticateGet200ResponseToJSON,
} from '../models/AllauthClientV1AuthWebauthnAuthenticateGet200Response';
import {
    type AllauthClientV1AuthWebauthnAuthenticatePostRequest,
    AllauthClientV1AuthWebauthnAuthenticatePostRequestFromJSON,
    AllauthClientV1AuthWebauthnAuthenticatePostRequestToJSON,
} from '../models/AllauthClientV1AuthWebauthnAuthenticatePostRequest';
import {
...
export class AuthenticationWebAuthnLoginApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for allauthClientV1AuthWebauthnAuthenticateGet without sending the request
     */
    async allauthClientV1AuthWebauthnAuthenticateGetRequestOpts(requestParameters: AllauthClientV1AuthWebauthnAuthenticateGetRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/_allauth/{client}/v1/auth/webauthn/authenticate`;
    ...
    async allauthClientV1AuthWebauthnAuthenticateGetRaw(requestParameters: AllauthClientV1AuthWebauthnAuthenticateGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AuthWebauthnAuthenticateGet200Response>> {
        const requestOptions = await this.allauthClientV1AuthWebauthnAuthenticateGetRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for allauthClientV1AuthWebauthnAuthenticatePost without sending the request
     */
    async allauthClientV1AuthWebauthnAuthenticatePostRequestOpts(requestParameters: AllauthClientV1AuthWebauthnAuthenticatePostOperationRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
    ...
    async allauthClientV1AuthWebauthnAuthenticatePostRaw(requestParameters: AllauthClientV1AuthWebauthnAuthenticatePostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthenticatedResponse>> {
        const requestOptions = await this.allauthClientV1AuthWebauthnAuthenticatePostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for allauthClientV1AuthWebauthnLoginGet without sending the request
     */
    async allauthClientV1AuthWebauthnLoginGetRequestOpts(requestParameters: AllauthClientV1AuthWebauthnLoginGetRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
        ...
        let urlPath = `/_allauth/{client}/v1/auth/webauthn/login`;
        urlPath = urlPath.replace('{client}', encodeURIComponent(String(requestParameters['client'])));
    ...
    async allauthClientV1AuthWebauthnLoginGetRaw(requestParameters: AllauthClientV1AuthWebauthnLoginGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AuthWebauthnAuthenticateGet200Response>> {
        const requestOptions = await this.allauthClientV1AuthWebauthnLoginGetRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for allauthClientV1AuthWebauthnLoginPost without sending the request
     */
    async allauthClientV1AuthWebauthnLoginPostRequestOpts(requestParameters: AllauthClientV1AuthWebauthnLoginPostRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
    ...
    async allauthClientV1AuthWebauthnLoginPostRaw(requestParameters: AllauthClientV1AuthWebauthnLoginPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthenticatedResponse>> {
        const requestOptions = await this.allauthClientV1AuthWebauthnLoginPostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for allauthClientV1AuthWebauthnReauthenticateGet without sending the request
     */
    async allauthClientV1AuthWebauthnReauthenticateGetRequestOpts(requestParameters: AllauthClientV1AuthWebauthnReauthenticateGetRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
        ...
        let urlPath = `/_allauth/{client}/v1/auth/webauthn/reauthenticate`;
        urlPath = urlPath.replace('{client}', encodeURIComponent(String(requestParameters['client'])));
    ...
    async allauthClientV1AuthWebauthnReauthenticateGetRaw(requestParameters: AllauthClientV1AuthWebauthnReauthenticateGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AuthWebauthnAuthenticateGet200Response>> {
        const requestOptions = await this.allauthClientV1AuthWebauthnReauthenticateGetRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for allauthClientV1AuthWebauthnReauthenticatePost without sending the request
     */
    async allauthClientV1AuthWebauthnReauthenticatePostRequestOpts(requestParameters: AllauthClientV1AuthWebauthnReauthenticatePostRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
    ...
    async allauthClientV1AuthWebauthnReauthenticatePostRaw(requestParameters: AllauthClientV1AuthWebauthnReauthenticatePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthenticatedResponse>> {
        const requestOptions = await this.allauthClientV1AuthWebauthnReauthenticatePostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
