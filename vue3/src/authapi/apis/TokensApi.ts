...
import {
    type AllauthAppV1TokensRefreshPost200Response,
    AllauthAppV1TokensRefreshPost200ResponseFromJSON,
    AllauthAppV1TokensRefreshPost200ResponseToJSON,
} from '../models/AllauthAppV1TokensRefreshPost200Response';
import {
    type AllauthAppV1TokensRefreshPostRequest,
    AllauthAppV1TokensRefreshPostRequestFromJSON,
    AllauthAppV1TokensRefreshPostRequestToJSON,
} from '../models/AllauthAppV1TokensRefreshPostRequest';
import {
    type ErrorResponse,
...
export interface AllauthAppV1TokensRefreshPostOperationRequest {
    allauthAppV1TokensRefreshPostRequest?: AllauthAppV1TokensRefreshPostRequest;
}
...
export class TokensApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for allauthAppV1TokensRefreshPost without sending the request
     */
    async allauthAppV1TokensRefreshPostRequestOpts(requestParameters: AllauthAppV1TokensRefreshPostOperationRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/_allauth/app/v1/tokens/refresh`;
        ...
        return {
            ...
            body: AllauthAppV1TokensRefreshPostRequestToJSON(requestParameters['allauthAppV1TokensRefreshPostRequest']),
        };
    }
     ...
     */
    async allauthAppV1TokensRefreshPostRaw(requestParameters: AllauthAppV1TokensRefreshPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthAppV1TokensRefreshPost200Response>> {
        const requestOptions = await this.allauthAppV1TokensRefreshPostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => AllauthAppV1TokensRefreshPost200ResponseFromJSON(jsonValue));
    }
     ...
     * Refresh the access token 
     */
    async allauthAppV1TokensRefreshPost(requestParameters: AllauthAppV1TokensRefreshPostOperationRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AllauthAppV1TokensRefreshPost200Response> {
        const response = await this.allauthAppV1TokensRefreshPostRaw(requestParameters, initOverrides);
