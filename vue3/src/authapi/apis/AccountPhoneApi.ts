...
import {
    type AllauthClientV1AccountPhonePostRequest,
    AllauthClientV1AccountPhonePostRequestFromJSON,
    AllauthClientV1AccountPhonePostRequestToJSON,
} from '../models/AllauthClientV1AccountPhonePostRequest';
import {
...
export class AccountPhoneApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for allauthClientV1AccountPhoneGet without sending the request
     */
    async allauthClientV1AccountPhoneGetRequestOpts(requestParameters: AllauthClientV1AccountPhoneGetRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/_allauth/{client}/v1/account/phone`;
    ...
    async allauthClientV1AccountPhoneGetRaw(requestParameters: AllauthClientV1AccountPhoneGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PhoneNumbersResponse>> {
        const requestOptions = await this.allauthClientV1AccountPhoneGetRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for allauthClientV1AccountPhonePost without sending the request
     */
    async allauthClientV1AccountPhonePostRequestOpts(requestParameters: AllauthClientV1AccountPhonePostOperationRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
    ...
    async allauthClientV1AccountPhonePostRaw(requestParameters: AllauthClientV1AccountPhonePostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PhoneNumberChangeResponse>> {
        const requestOptions = await this.allauthClientV1AccountPhonePostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
