...
import {
    type AllauthClientV1AccountAuthenticatorsGet200Response,
    AllauthClientV1AccountAuthenticatorsGet200ResponseFromJSON,
    AllauthClientV1AccountAuthenticatorsGet200ResponseToJSON,
} from '../models/AllauthClientV1AccountAuthenticatorsGet200Response';
import {
    type AllauthClientV1AccountAuthenticatorsRecoveryCodesGet200Response,
...
} from '../models/AllauthClientV1AccountAuthenticatorsRecoveryCodesGet200Response';
import {
    type AllauthClientV1AccountAuthenticatorsRecoveryCodesGet404Response,
...
} from '../models/AllauthClientV1AccountAuthenticatorsRecoveryCodesGet404Response';
import {
...
import {
    type AllauthClientV1AccountAuthenticatorsTotpGet200Response,
...
} from '../models/AllauthClientV1AccountAuthenticatorsTotpGet200Response';
import {
    type AllauthClientV1AccountAuthenticatorsTotpGet404Response,
...
} from '../models/AllauthClientV1AccountAuthenticatorsTotpGet404Response';
import {
    type AllauthClientV1AccountAuthenticatorsTotpPostRequest,
    AllauthClientV1AccountAuthenticatorsTotpPostRequestFromJSON,
    AllauthClientV1AccountAuthenticatorsTotpPostRequestToJSON,
} from '../models/AllauthClientV1AccountAuthenticatorsTotpPostRequest';
import {
...
} from '../models/SessionGoneResponse';
...
export interface AllauthClientV1AccountAuthenticatorsTotpPostOperationRequest {
    client: AllauthClientV1AccountAuthenticatorsTotpPostOperationClientEnum;
    xSessionToken?: string;
...
export class Account2FAApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for allauthClientV1AccountAuthenticatorsGet without sending the request
     */
    async allauthClientV1AccountAuthenticatorsGetRequestOpts(requestParameters: AllauthClientV1AccountAuthenticatorsGetRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/_allauth/{client}/v1/account/authenticators`;
    ...
    async allauthClientV1AccountAuthenticatorsGetRaw(requestParameters: AllauthClientV1AccountAuthenticatorsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AccountAuthenticatorsGet200Response>> {
        const requestOptions = await this.allauthClientV1AccountAuthenticatorsGetRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for allauthClientV1AccountAuthenticatorsRecoveryCodesGet without sending the request
     */
    async allauthClientV1AccountAuthenticatorsRecoveryCodesGetRequestOpts(requestParameters: AllauthClientV1AccountAuthenticatorsRecoveryCodesGetRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
        ...
        let urlPath = `/_allauth/{client}/v1/account/authenticators/recovery-codes`;
        urlPath = urlPath.replace('{client}', encodeURIComponent(String(requestParameters['client'])));
    ...
    async allauthClientV1AccountAuthenticatorsRecoveryCodesGetRaw(requestParameters: AllauthClientV1AccountAuthenticatorsRecoveryCodesGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AccountAuthenticatorsRecoveryCodesGet200Response>> {
        const requestOptions = await this.allauthClientV1AccountAuthenticatorsRecoveryCodesGetRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for allauthClientV1AccountAuthenticatorsRecoveryCodesPost without sending the request
     */
    async allauthClientV1AccountAuthenticatorsRecoveryCodesPostRequestOpts(requestParameters: AllauthClientV1AccountAuthenticatorsRecoveryCodesPostRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
    ...
    async allauthClientV1AccountAuthenticatorsRecoveryCodesPostRaw(requestParameters: AllauthClientV1AccountAuthenticatorsRecoveryCodesPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.allauthClientV1AccountAuthenticatorsRecoveryCodesPostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for allauthClientV1AccountAuthenticatorsTotpDelete without sending the request
     */
    async allauthClientV1AccountAuthenticatorsTotpDeleteRequestOpts(requestParameters: AllauthClientV1AccountAuthenticatorsTotpDeleteRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
        ...
        let urlPath = `/_allauth/{client}/v1/account/authenticators/totp`;
        urlPath = urlPath.replace('{client}', encodeURIComponent(String(requestParameters['client'])));
     ...
     * Deactivate TOTP
     */
    async allauthClientV1AccountAuthenticatorsTotpDeleteRaw(requestParameters: AllauthClientV1AccountAuthenticatorsTotpDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AccountAuthenticatorsTotpDelete200Response>> {
        const requestOptions = await this.allauthClientV1AccountAuthenticatorsTotpDeleteRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Deactivate TOTP
     */
    async allauthClientV1AccountAuthenticatorsTotpDelete(requestParameters: AllauthClientV1AccountAuthenticatorsTotpDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AllauthClientV1AccountAuthenticatorsTotpDelete200Response> {
        const response = await this.allauthClientV1AccountAuthenticatorsTotpDeleteRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * Creates request options for allauthClientV1AccountAuthenticatorsTotpGet without sending the request
     */
    async allauthClientV1AccountAuthenticatorsTotpGetRequestOpts(requestParameters: AllauthClientV1AccountAuthenticatorsTotpGetRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
    ...
    async allauthClientV1AccountAuthenticatorsTotpGetRaw(requestParameters: AllauthClientV1AccountAuthenticatorsTotpGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AccountAuthenticatorsTotpGet200Response>> {
        const requestOptions = await this.allauthClientV1AccountAuthenticatorsTotpGetRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for allauthClientV1AccountAuthenticatorsTotpPost without sending the request
     */
    async allauthClientV1AccountAuthenticatorsTotpPostRequestOpts(requestParameters: AllauthClientV1AccountAuthenticatorsTotpPostOperationRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
    ...
    async allauthClientV1AccountAuthenticatorsTotpPostRaw(requestParameters: AllauthClientV1AccountAuthenticatorsTotpPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AccountAuthenticatorsTotpGet200Response>> {
        const requestOptions = await this.allauthClientV1AccountAuthenticatorsTotpPostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
