...
export interface AllauthClientV1AuthCodeResendPostRequest {
    client: AllauthClientV1AuthCodeResendPostClientEnum;
...
export class AuthenticationLoginByCodeApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for allauthClientV1AuthCodeConfirmPost without sending the request
     */
    async allauthClientV1AuthCodeConfirmPostRequestOpts(requestParameters: AllauthClientV1AuthCodeConfirmPostRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/_allauth/{client}/v1/auth/code/confirm`;
    ...
    async allauthClientV1AuthCodeConfirmPostRaw(requestParameters: AllauthClientV1AuthCodeConfirmPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthenticatedResponse>> {
        const requestOptions = await this.allauthClientV1AuthCodeConfirmPostRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for allauthClientV1AuthCodeRequestPost without sending the request
     */
    async allauthClientV1AuthCodeRequestPostRequestOpts(requestParameters: AllauthClientV1AuthCodeRequestPostRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
        ...
        let urlPath = `/_allauth/{client}/v1/auth/code/request`;
        urlPath = urlPath.replace('{client}', encodeURIComponent(String(requestParameters['client'])));
    ...
    async allauthClientV1AuthCodeRequestPostRaw(requestParameters: AllauthClientV1AuthCodeRequestPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.allauthClientV1AuthCodeRequestPostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for allauthClientV1AuthCodeResendPost without sending the request
     */
    async allauthClientV1AuthCodeResendPostRequestOpts(requestParameters: AllauthClientV1AuthCodeResendPostRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
                'Required parameter "client" was null or undefined when calling allauthClientV1AuthCodeResendPost().'
            );
        }
        ...
        let urlPath = `/_allauth/{client}/v1/auth/code/resend`;
        urlPath = urlPath.replace('{client}', encodeURIComponent(String(requestParameters['client'])));
     ...
     * Resend login code
     */
    async allauthClientV1AuthCodeResendPostRaw(requestParameters: AllauthClientV1AuthCodeResendPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AccountAuthenticatorsTotpDelete200Response>> {
        const requestOptions = await this.allauthClientV1AuthCodeResendPostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Resend login code
     */
    async allauthClientV1AuthCodeResendPost(requestParameters: AllauthClientV1AuthCodeResendPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AllauthClientV1AccountAuthenticatorsTotpDelete200Response> {
        const response = await this.allauthClientV1AuthCodeResendPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const AllauthClientV1AuthCodeResendPostClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
export type AllauthClientV1AuthCodeResendPostClientEnum = typeof AllauthClientV1AuthCodeResendPostClientEnum[keyof typeof AllauthClientV1AuthCodeResendPostClientEnum];
