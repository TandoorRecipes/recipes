...
import {
    type AllauthClientV1AccountAuthenticatorsWebauthnDeleteRequest,
...
} from '../models/AllauthClientV1AccountAuthenticatorsWebauthnDeleteRequest';
import {
    type AllauthClientV1AccountAuthenticatorsWebauthnGet200Response,
...
} from '../models/AllauthClientV1AccountAuthenticatorsWebauthnGet200Response';
import {
    type AllauthClientV1AccountAuthenticatorsWebauthnPost200Response,
...
} from '../models/AllauthClientV1AccountAuthenticatorsWebauthnPost200Response';
import {
    type AllauthClientV1AccountAuthenticatorsWebauthnPostRequest,
    AllauthClientV1AccountAuthenticatorsWebauthnPostRequestFromJSON,
    AllauthClientV1AccountAuthenticatorsWebauthnPostRequestToJSON,
} from '../models/AllauthClientV1AccountAuthenticatorsWebauthnPostRequest';
import {
    type AllauthClientV1AccountAuthenticatorsWebauthnPut200Response,
...
} from '../models/AllauthClientV1AccountAuthenticatorsWebauthnPut200Response';
import {
    type AllauthClientV1AccountAuthenticatorsWebauthnPutRequest,
...
} from '../models/AllauthClientV1AccountAuthenticatorsWebauthnPutRequest';
import {
...
export interface AllauthClientV1AccountAuthenticatorsWebauthnPostOperationRequest {
    client: AllauthClientV1AccountAuthenticatorsWebauthnPostOperationClientEnum;
    xSessionToken?: string;
    allauthClientV1AccountAuthenticatorsWebauthnPostRequest?: AllauthClientV1AccountAuthenticatorsWebauthnPostRequest;
}
...
export class AccountWebAuthnApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for allauthClientV1AccountAuthenticatorsWebauthnDelete without sending the request
     */
    async allauthClientV1AccountAuthenticatorsWebauthnDeleteRequestOpts(requestParameters: AllauthClientV1AccountAuthenticatorsWebauthnDeleteOperationRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/_allauth/{client}/v1/account/authenticators/webauthn`;
     ...
     */
    async allauthClientV1AccountAuthenticatorsWebauthnDeleteRaw(requestParameters: AllauthClientV1AccountAuthenticatorsWebauthnDeleteOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AccountAuthenticatorsTotpDelete200Response>> {
        const requestOptions = await this.allauthClientV1AccountAuthenticatorsWebauthnDeleteRequestOpts(requestParameters);
     ...
     * Delete a WebAuthn credential 
     */
    async allauthClientV1AccountAuthenticatorsWebauthnDelete(requestParameters: AllauthClientV1AccountAuthenticatorsWebauthnDeleteOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AllauthClientV1AccountAuthenticatorsTotpDelete200Response> {
        const response = await this.allauthClientV1AccountAuthenticatorsWebauthnDeleteRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * Creates request options for allauthClientV1AccountAuthenticatorsWebauthnGet without sending the request
     */
    async allauthClientV1AccountAuthenticatorsWebauthnGetRequestOpts(requestParameters: AllauthClientV1AccountAuthenticatorsWebauthnGetRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
        ...
        if (requestParameters['passwordless'] != null) {
            queryParameters['passwordless'] = requestParameters['passwordless'];
        }
    ...
    async allauthClientV1AccountAuthenticatorsWebauthnGetRaw(requestParameters: AllauthClientV1AccountAuthenticatorsWebauthnGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AccountAuthenticatorsWebauthnGet200Response>> {
        const requestOptions = await this.allauthClientV1AccountAuthenticatorsWebauthnGetRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for allauthClientV1AccountAuthenticatorsWebauthnPost without sending the request
     */
    async allauthClientV1AccountAuthenticatorsWebauthnPostRequestOpts(requestParameters: AllauthClientV1AccountAuthenticatorsWebauthnPostOperationRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
        ...
        return {
            ...
            headers: headerParameters,
            query: queryParameters,
            body: AllauthClientV1AccountAuthenticatorsWebauthnPostRequestToJSON(requestParameters['allauthClientV1AccountAuthenticatorsWebauthnPostRequest']),
        };
    }
     ...
     */
    async allauthClientV1AccountAuthenticatorsWebauthnPostRaw(requestParameters: AllauthClientV1AccountAuthenticatorsWebauthnPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AccountAuthenticatorsWebauthnPost200Response>> {
        const requestOptions = await this.allauthClientV1AccountAuthenticatorsWebauthnPostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Add a WebAuthn credential 
     */
    async allauthClientV1AccountAuthenticatorsWebauthnPost(requestParameters: AllauthClientV1AccountAuthenticatorsWebauthnPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AllauthClientV1AccountAuthenticatorsWebauthnPost200Response> {
        const response = await this.allauthClientV1AccountAuthenticatorsWebauthnPostRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * Creates request options for allauthClientV1AccountAuthenticatorsWebauthnPut without sending the request
     */
    async allauthClientV1AccountAuthenticatorsWebauthnPutRequestOpts(requestParameters: AllauthClientV1AccountAuthenticatorsWebauthnPutOperationRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
    ...
    async allauthClientV1AccountAuthenticatorsWebauthnPutRaw(requestParameters: AllauthClientV1AccountAuthenticatorsWebauthnPutOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AccountAuthenticatorsWebauthnPut200Response>> {
        const requestOptions = await this.allauthClientV1AccountAuthenticatorsWebauthnPutRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
 ...
 * @export
 */
export const AllauthClientV1AccountAuthenticatorsWebauthnPostOperationClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
export type AllauthClientV1AccountAuthenticatorsWebauthnPostOperationClientEnum = typeof AllauthClientV1AccountAuthenticatorsWebauthnPostOperationClientEnum[keyof typeof AllauthClientV1AccountAuthenticatorsWebauthnPostOperationClientEnum];
/**
 * @export
 */
