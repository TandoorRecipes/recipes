...
import {
    type AllauthClientV1AccountPasswordChangePostRequest,
    AllauthClientV1AccountPasswordChangePostRequestFromJSON,
    AllauthClientV1AccountPasswordChangePostRequestToJSON,
} from '../models/AllauthClientV1AccountPasswordChangePostRequest';
import {
...
export interface AllauthClientV1AccountPasswordChangePostOperationRequest {
    client: AllauthClientV1AccountPasswordChangePostOperationClientEnum;
...
export class AccountPasswordApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for allauthClientV1AccountPasswordChangePost without sending the request
     */
    async allauthClientV1AccountPasswordChangePostRequestOpts(requestParameters: AllauthClientV1AccountPasswordChangePostOperationRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/_allauth/{client}/v1/account/password/change`;
    ...
    async allauthClientV1AccountPasswordChangePostRaw(requestParameters: AllauthClientV1AccountPasswordChangePostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.allauthClientV1AccountPasswordChangePostRequestOpts(requestParameters);
