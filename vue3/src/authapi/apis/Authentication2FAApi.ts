...
} from '../models/MFAAuthenticate';
import {
    type MFATrust,
    MFATrustFromJSON,
    MFATrustToJSON,
} from '../models/MFATrust';

export interface AllauthBrowserV1Auth2faTrustPostRequest {
    mFATrust: MFATrust;
...
export class Authentication2FAApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for allauthBrowserV1Auth2faTrustPost without sending the request
     */
    async allauthBrowserV1Auth2faTrustPostRequestOpts(requestParameters: AllauthBrowserV1Auth2faTrustPostRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['mFATrust'] == null) {
            throw new runtime.RequiredError(
                'mFATrust',
                'Required parameter "mFATrust" was null or undefined when calling allauthBrowserV1Auth2faTrustPost().'
            );
        }
        ...
        let urlPath = `/_allauth/browser/v1/auth/2fa/trust`;
        ...
        return {
            ...
            body: MFATrustToJSON(requestParameters['mFATrust']),
        };
    }
     ...
     * Trust this browser
     */
    async allauthBrowserV1Auth2faTrustPostRaw(requestParameters: AllauthBrowserV1Auth2faTrustPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthenticatedResponse>> {
        const requestOptions = await this.allauthBrowserV1Auth2faTrustPostRequestOpts(requestParameters);
     ...
     * Trust this browser
     */
    async allauthBrowserV1Auth2faTrustPost(requestParameters: AllauthBrowserV1Auth2faTrustPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AuthenticatedResponse> {
        const response = await this.allauthBrowserV1Auth2faTrustPostRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * Creates request options for allauthClientV1Auth2faAuthenticatePost without sending the request
     */
    async allauthClientV1Auth2faAuthenticatePostRequestOpts(requestParameters: AllauthClientV1Auth2faAuthenticatePostRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/_allauth/{client}/v1/auth/2fa/authenticate`;
    ...
    async allauthClientV1Auth2faAuthenticatePostRaw(requestParameters: AllauthClientV1Auth2faAuthenticatePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthenticatedResponse>> {
        const requestOptions = await this.allauthClientV1Auth2faAuthenticatePostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for allauthClientV1Auth2faReauthenticatePost without sending the request
     */
    async allauthClientV1Auth2faReauthenticatePostRequestOpts(requestParameters: AllauthClientV1Auth2faReauthenticatePostRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
        ...
        if (requestParameters['mFAAuthenticate'] == null) {
            throw new runtime.RequiredError(
                'mFAAuthenticate',
                'Required parameter "mFAAuthenticate" was null or undefined when calling allauthClientV1Auth2faReauthenticatePost().'
            );
        }
        ...
        let urlPath = `/_allauth/{client}/v1/auth/2fa/reauthenticate`;
        urlPath = urlPath.replace('{client}', encodeURIComponent(String(requestParameters['client'])));
    ...
    async allauthClientV1Auth2faReauthenticatePostRaw(requestParameters: AllauthClientV1Auth2faReauthenticatePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthenticatedResponse>> {
        const requestOptions = await this.allauthClientV1Auth2faReauthenticatePostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
