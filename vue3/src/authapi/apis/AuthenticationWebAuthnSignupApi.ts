...
export interface AllauthClientV1AuthWebauthnSignupPutRequest {
    client: AllauthClientV1AuthWebauthnSignupPutClientEnum;
    xSessionToken?: string;
...
export class AuthenticationWebAuthnSignupApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for allauthClientV1AuthWebauthnSignupGet without sending the request
     */
    async allauthClientV1AuthWebauthnSignupGetRequestOpts(requestParameters: AllauthClientV1AuthWebauthnSignupGetRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/_allauth/{client}/v1/auth/webauthn/signup`;
    ...
    async allauthClientV1AuthWebauthnSignupGetRaw(requestParameters: AllauthClientV1AuthWebauthnSignupGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AuthWebauthnAuthenticateGet200Response>> {
        const requestOptions = await this.allauthClientV1AuthWebauthnSignupGetRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for allauthClientV1AuthWebauthnSignupPost without sending the request
     */
    async allauthClientV1AuthWebauthnSignupPostRequestOpts(requestParameters: AllauthClientV1AuthWebauthnSignupPostRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
    ...
    async allauthClientV1AuthWebauthnSignupPostRaw(requestParameters: AllauthClientV1AuthWebauthnSignupPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.allauthClientV1AuthWebauthnSignupPostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for allauthClientV1AuthWebauthnSignupPut without sending the request
     */
    async allauthClientV1AuthWebauthnSignupPutRequestOpts(requestParameters: AllauthClientV1AuthWebauthnSignupPutRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
     ...
     */
    async allauthClientV1AuthWebauthnSignupPutRaw(requestParameters: AllauthClientV1AuthWebauthnSignupPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthenticatedResponse>> {
        const requestOptions = await this.allauthClientV1AuthWebauthnSignupPutRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Complete the passkey signup flow
     */
    async allauthClientV1AuthWebauthnSignupPut(requestParameters: AllauthClientV1AuthWebauthnSignupPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AuthenticatedResponse> {
 ...
 * @export
 */
export const AllauthClientV1AuthWebauthnSignupPutClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
export type AllauthClientV1AuthWebauthnSignupPutClientEnum = typeof AllauthClientV1AuthWebauthnSignupPutClientEnum[keyof typeof AllauthClientV1AuthWebauthnSignupPutClientEnum];
