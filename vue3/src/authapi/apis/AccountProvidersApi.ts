...
import {
    type AllauthClientV1AccountProvidersDeleteRequest,
    AllauthClientV1AccountProvidersDeleteRequestFromJSON,
    AllauthClientV1AccountProvidersDeleteRequestToJSON,
} from '../models/AllauthClientV1AccountProvidersDeleteRequest';
import {
    type AllauthClientV1AccountProvidersGet200Response,
    AllauthClientV1AccountProvidersGet200ResponseFromJSON,
    AllauthClientV1AccountProvidersGet200ResponseToJSON,
} from '../models/AllauthClientV1AccountProvidersGet200Response';
import {
    type ErrorResponse,
...
export interface AllauthClientV1AccountProvidersDeleteOperationRequest {
    client: AllauthClientV1AccountProvidersDeleteOperationClientEnum;
...
export class AccountProvidersApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for allauthClientV1AccountProvidersDelete without sending the request
     */
    async allauthClientV1AccountProvidersDeleteRequestOpts(requestParameters: AllauthClientV1AccountProvidersDeleteOperationRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/_allauth/{client}/v1/account/providers`;
    ...
    async allauthClientV1AccountProvidersDeleteRaw(requestParameters: AllauthClientV1AccountProvidersDeleteOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AccountProvidersGet200Response>> {
        const requestOptions = await this.allauthClientV1AccountProvidersDeleteRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for allauthClientV1AccountProvidersGet without sending the request
     */
    async allauthClientV1AccountProvidersGetRequestOpts(requestParameters: AllauthClientV1AccountProvidersGetRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
    ...
    async allauthClientV1AccountProvidersGetRaw(requestParameters: AllauthClientV1AccountProvidersGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AccountProvidersGet200Response>> {
        const requestOptions = await this.allauthClientV1AccountProvidersGetRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
