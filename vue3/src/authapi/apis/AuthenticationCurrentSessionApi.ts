...
export class AuthenticationCurrentSessionApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for allauthClientV1AuthSessionDelete without sending the request
     */
    async allauthClientV1AuthSessionDeleteRequestOpts(requestParameters: AllauthClientV1AuthSessionDeleteRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/_allauth/{client}/v1/auth/session`;
    ...
    async allauthClientV1AuthSessionDeleteRaw(requestParameters: AllauthClientV1AuthSessionDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.allauthClientV1AuthSessionDeleteRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for allauthClientV1AuthSessionGet without sending the request
     */
    async allauthClientV1AuthSessionGetRequestOpts(requestParameters: AllauthClientV1AuthSessionGetRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
    ...
    async allauthClientV1AuthSessionGetRaw(requestParameters: AllauthClientV1AuthSessionGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthenticatedResponse>> {
        const requestOptions = await this.allauthClientV1AuthSessionGetRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
