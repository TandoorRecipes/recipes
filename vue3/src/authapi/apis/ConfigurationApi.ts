...
export class ConfigurationApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for allauthClientV1ConfigGet without sending the request
     */
    async allauthClientV1ConfigGetRequestOpts(requestParameters: AllauthClientV1ConfigGetRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/_allauth/{client}/v1/config`;
    ...
    async allauthClientV1ConfigGetRaw(requestParameters: AllauthClientV1ConfigGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConfigurationResponse>> {
        const requestOptions = await this.allauthClientV1ConfigGetRequestOpts(requestParameters);
