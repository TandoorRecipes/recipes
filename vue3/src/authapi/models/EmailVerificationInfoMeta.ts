...
export function instanceOfEmailVerificationInfoMeta(value: object): value is EmailVerificationInfoMeta {
    if ((!('isAuthenticating' in (value as Record<string, any>)) && !('is_authenticating' in (value as Record<string, any>))) || ((value as Record<string, any>)['isAuthenticating'] === undefined && (value as Record<string, any>)['is_authenticating'] === undefined)) return false;
    return true;
}
...
export function EmailVerificationInfoMetaToJSON(json: any): EmailVerificationInfoMeta {
    return EmailVerificationInfoMetaToJSONTyped(json, false);
}

export function EmailVerificationInfoMetaToJSONTyped(value?: EmailVerificationInfoMeta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
