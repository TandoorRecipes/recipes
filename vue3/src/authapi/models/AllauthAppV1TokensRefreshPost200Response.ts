...
import type { AllauthAppV1TokensRefreshPost200ResponseData } from './AllauthAppV1TokensRefreshPost200ResponseData';
import {
    AllauthAppV1TokensRefreshPost200ResponseDataFromJSON,
    AllauthAppV1TokensRefreshPost200ResponseDataFromJSONTyped,
    AllauthAppV1TokensRefreshPost200ResponseDataToJSON,
    AllauthAppV1TokensRefreshPost200ResponseDataToJSONTyped,
} from './AllauthAppV1TokensRefreshPost200ResponseData';

/**
 * 
 * @export
 * @interface AllauthAppV1TokensRefreshPost200Response
 */
export interface AllauthAppV1TokensRefreshPost200Response {
    /**
     * 
     * @type {AllauthAppV1TokensRefreshPost200ResponseData}
     * @memberof AllauthAppV1TokensRefreshPost200Response
     */
    data: AllauthAppV1TokensRefreshPost200ResponseData;
    /**
     * 
     * @type {StatusOK}
     * @memberof AllauthAppV1TokensRefreshPost200Response
...
/**
 * Check if a given object implements the AllauthAppV1TokensRefreshPost200Response interface.
 */
export function instanceOfAllauthAppV1TokensRefreshPost200Response(value: object): value is AllauthAppV1TokensRefreshPost200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('status' in value) || value['status'] === undefined) return false;
    return true;
}

export function AllauthAppV1TokensRefreshPost200ResponseFromJSON(json: any): AllauthAppV1TokensRefreshPost200Response {
    return AllauthAppV1TokensRefreshPost200ResponseFromJSONTyped(json, false);
}

export function AllauthAppV1TokensRefreshPost200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AllauthAppV1TokensRefreshPost200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': AllauthAppV1TokensRefreshPost200ResponseDataFromJSON(json['data']),
        'status': StatusOKFromJSON(json['status']),
    };
}

export function AllauthAppV1TokensRefreshPost200ResponseToJSON(json: any): AllauthAppV1TokensRefreshPost200Response {
    return AllauthAppV1TokensRefreshPost200ResponseToJSONTyped(json, false);
}

export function AllauthAppV1TokensRefreshPost200ResponseToJSONTyped(value?: AllauthAppV1TokensRefreshPost200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': AllauthAppV1TokensRefreshPost200ResponseDataToJSON(value['data']),
