...
export function instanceOfWebAuthnCredentialCreationOptions(value: object): value is WebAuthnCredentialCreationOptions {
    if ((!('creationOptions' in (value as Record<string, any>)) && !('creation_options' in (value as Record<string, any>))) || ((value as Record<string, any>)['creationOptions'] === undefined && (value as Record<string, any>)['creation_options'] === undefined)) return false;
    return true;
}
