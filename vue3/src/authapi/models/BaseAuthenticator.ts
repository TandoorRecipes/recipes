...
export function BaseAuthenticatorToJSON(json: any): BaseAuthenticator {
    return BaseAuthenticatorToJSONTyped(json, false);
}

export function BaseAuthenticatorToJSONTyped(value?: BaseAuthenticator | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
