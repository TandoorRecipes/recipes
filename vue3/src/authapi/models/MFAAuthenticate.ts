...
export function MFAAuthenticateToJSON(json: any): MFAAuthenticate {
    return MFAAuthenticateToJSONTyped(json, false);
}

export function MFAAuthenticateToJSONTyped(value?: MFAAuthenticate | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
