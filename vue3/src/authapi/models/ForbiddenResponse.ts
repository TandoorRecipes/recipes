...
export interface ForbiddenResponse {
    /**
     * 
     * @type {ForbiddenResponseStatusEnum}
...
export function ForbiddenResponseToJSON(json: any): ForbiddenResponse {
    return ForbiddenResponseToJSONTyped(json, false);
}

export function ForbiddenResponseToJSONTyped(value?: ForbiddenResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
