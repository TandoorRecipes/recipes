...
export function BaseAuthenticationMetaToJSON(json: any): BaseAuthenticationMeta {
    return BaseAuthenticationMetaToJSONTyped(json, false);
}

export function BaseAuthenticationMetaToJSONTyped(value?: BaseAuthenticationMeta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
