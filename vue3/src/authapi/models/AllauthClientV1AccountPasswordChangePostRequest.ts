...
export function AllauthClientV1AccountPasswordChangePostRequestToJSON(json: any): AllauthClientV1AccountPasswordChangePostRequest {
    return AllauthClientV1AccountPasswordChangePostRequestToJSONTyped(json, false);
}

export function AllauthClientV1AccountPasswordChangePostRequestToJSONTyped(value?: AllauthClientV1AccountPasswordChangePostRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
