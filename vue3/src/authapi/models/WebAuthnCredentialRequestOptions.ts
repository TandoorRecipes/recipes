...
export function instanceOfWebAuthnCredentialRequestOptions(value: object): value is WebAuthnCredentialRequestOptions {
    if ((!('_requestOptions' in (value as Record<string, any>)) && !('request_options' in (value as Record<string, any>))) || ((value as Record<string, any>)['_requestOptions'] === undefined && (value as Record<string, any>)['request_options'] === undefined)) return false;
    return true;
}
