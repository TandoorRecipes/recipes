...
export function AllauthClientV1AccountEmailPutRequestToJSON(json: any): AllauthClientV1AccountEmailPutRequest {
    return AllauthClientV1AccountEmailPutRequestToJSONTyped(json, false);
}

export function AllauthClientV1AccountEmailPutRequestToJSONTyped(value?: AllauthClientV1AccountEmailPutRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
