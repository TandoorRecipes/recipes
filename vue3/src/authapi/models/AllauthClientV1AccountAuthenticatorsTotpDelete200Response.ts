 ...
 * 
 * @export
 * @interface AllauthClientV1AccountAuthenticatorsTotpDelete200Response
 */
export interface AllauthClientV1AccountAuthenticatorsTotpDelete200Response {
    /**
     * 
     * @type {StatusOK}
     * @memberof AllauthClientV1AccountAuthenticatorsTotpDelete200Response
     */
    status: StatusOK;
}
...
/**
 * Check if a given object implements the AllauthClientV1AccountAuthenticatorsTotpDelete200Response interface.
 */
export function instanceOfAllauthClientV1AccountAuthenticatorsTotpDelete200Response(value: object): value is AllauthClientV1AccountAuthenticatorsTotpDelete200Response {
    if (!('status' in value) || value['status'] === undefined) return false;
    return true;
}

export function AllauthClientV1AccountAuthenticatorsTotpDelete200ResponseFromJSON(json: any): AllauthClientV1AccountAuthenticatorsTotpDelete200Response {
    return AllauthClientV1AccountAuthenticatorsTotpDelete200ResponseFromJSONTyped(json, false);
}

export function AllauthClientV1AccountAuthenticatorsTotpDelete200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AllauthClientV1AccountAuthenticatorsTotpDelete200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function AllauthClientV1AccountAuthenticatorsTotpDelete200ResponseToJSON(json: any): AllauthClientV1AccountAuthenticatorsTotpDelete200Response {
    return AllauthClientV1AccountAuthenticatorsTotpDelete200ResponseToJSONTyped(json, false);
}

export function AllauthClientV1AccountAuthenticatorsTotpDelete200ResponseToJSONTyped(value?: AllauthClientV1AccountAuthenticatorsTotpDelete200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
