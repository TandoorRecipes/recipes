...
export function AllauthClientV1AccountProvidersDeleteRequestToJSON(json: any): AllauthClientV1AccountProvidersDeleteRequest {
    return AllauthClientV1AccountProvidersDeleteRequestToJSONTyped(json, false);
}

export function AllauthClientV1AccountProvidersDeleteRequestToJSONTyped(value?: AllauthClientV1AccountProvidersDeleteRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
