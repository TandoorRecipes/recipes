 ...
 * 
 * @export
 * @interface AllauthClientV1AuthCodeResendPost429Response
 */
export interface AllauthClientV1AuthCodeResendPost429Response {
    /**
     * 
     * @type {AllauthClientV1AuthCodeResendPost429ResponseStatusEnum}
     * @memberof AllauthClientV1AuthCodeResendPost429Response
     */
    status: AllauthClientV1AuthCodeResendPost429ResponseStatusEnum;
}
 ...
 * @export
 */
export const AllauthClientV1AuthCodeResendPost429ResponseStatusEnum = {
    NUMBER_429: 429
} as const;
export type AllauthClientV1AuthCodeResendPost429ResponseStatusEnum = typeof AllauthClientV1AuthCodeResendPost429ResponseStatusEnum[keyof typeof AllauthClientV1AuthCodeResendPost429ResponseStatusEnum];


/**
 * Check if a given object implements the AllauthClientV1AuthCodeResendPost429Response interface.
 */
export function instanceOfAllauthClientV1AuthCodeResendPost429Response(value: object): value is AllauthClientV1AuthCodeResendPost429Response {
...
export function AllauthClientV1AuthCodeResendPost429ResponseFromJSON(json: any): AllauthClientV1AuthCodeResendPost429Response {
    return AllauthClientV1AuthCodeResendPost429ResponseFromJSONTyped(json, false);
}

export function AllauthClientV1AuthCodeResendPost429ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AllauthClientV1AuthCodeResendPost429Response {
    if (json == null) {
        return json;
    }
    return {
...
export function AllauthClientV1AuthCodeResendPost429ResponseToJSON(json: any): AllauthClientV1AuthCodeResendPost429Response {
    return AllauthClientV1AuthCodeResendPost429ResponseToJSONTyped(json, false);
}

export function AllauthClientV1AuthCodeResendPost429ResponseToJSONTyped(value?: AllauthClientV1AuthCodeResendPost429Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
