...
export function SocialAccountConfigurationToJSON(json: any): SocialAccountConfiguration {
    return SocialAccountConfigurationToJSONTyped(json, false);
}

export function SocialAccountConfigurationToJSONTyped(value?: SocialAccountConfiguration | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
