 ...
 * 
 * @export
 * @interface AllauthAppV1TokensRefreshPost200ResponseData
 */
export interface AllauthAppV1TokensRefreshPost200ResponseData {
    /**
     * The access token.
     * 
     * @type {string}
     * @memberof AllauthAppV1TokensRefreshPost200ResponseData
     */
    accessToken: string;
    /**
     * The refresh token.
...
/**
 * Check if a given object implements the AllauthAppV1TokensRefreshPost200ResponseData interface.
 */
export function instanceOfAllauthAppV1TokensRefreshPost200ResponseData(value: object): value is AllauthAppV1TokensRefreshPost200ResponseData {
...
export function AllauthAppV1TokensRefreshPost200ResponseDataFromJSON(json: any): AllauthAppV1TokensRefreshPost200ResponseData {
    return AllauthAppV1TokensRefreshPost200ResponseDataFromJSONTyped(json, false);
}

export function AllauthAppV1TokensRefreshPost200ResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): AllauthAppV1TokensRefreshPost200ResponseData {
    if (json == null) {
        return json;
    }
    return {
...
export function AllauthAppV1TokensRefreshPost200ResponseDataToJSON(json: any): AllauthAppV1TokensRefreshPost200ResponseData {
    return AllauthAppV1TokensRefreshPost200ResponseDataToJSONTyped(json, false);
}

export function AllauthAppV1TokensRefreshPost200ResponseDataToJSONTyped(value?: AllauthAppV1TokensRefreshPost200ResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
