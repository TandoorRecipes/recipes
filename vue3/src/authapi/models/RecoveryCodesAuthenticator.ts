...
export function instanceOfRecoveryCodesAuthenticator(value: object): value is RecoveryCodesAuthenticator {
    ...
    if ((!('totalCodeCount' in (value as Record<string, any>)) && !('total_code_count' in (value as Record<string, any>))) || ((value as Record<string, any>)['totalCodeCount'] === undefined && (value as Record<string, any>)['total_code_count'] === undefined)) return false;
    if (!('type' in value) || value['type'] === undefined) return false;
    if (value['type'] !== 'recovery_codes') return false;
    
    if ((!('unusedCodeCount' in (value as Record<string, any>)) && !('unused_code_count' in (value as Record<string, any>))) || ((value as Record<string, any>)['unusedCodeCount'] === undefined && (value as Record<string, any>)['unused_code_count'] === undefined)) return false;
    return true;
}
...
export function RecoveryCodesAuthenticatorToJSON(json: any): RecoveryCodesAuthenticator {
    return RecoveryCodesAuthenticatorToJSONTyped(json, false);
}

export function RecoveryCodesAuthenticatorToJSONTyped(value?: RecoveryCodesAuthenticator | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
