...
export function ProviderFromJSONTyped(json: any, ignoreDiscriminator: boolean): Provider {
    ...
    return {
        ...
        'id': json['id'],
        'name': json['name'],
        'openidConfigurationUrl': json['openid_configuration_url'] == null ? undefined : json['openid_configuration_url'],
    };
}
...
export function ProviderToJSONTyped(value?: Provider | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'id': value['id'],
        'name': value['name'],
        'openid_configuration_url': value['openidConfigurationUrl'],
    };
}
