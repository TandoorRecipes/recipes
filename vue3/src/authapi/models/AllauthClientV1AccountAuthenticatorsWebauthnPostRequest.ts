 ...
 * 
 * @export
 * @interface AllauthClientV1AccountAuthenticatorsWebauthnPostRequest
 */
export interface AllauthClientV1AccountAuthenticatorsWebauthnPostRequest {
    /**
     * 
     * @type {object}
     * @memberof AllauthClientV1AccountAuthenticatorsWebauthnPostRequest
     */
    credential: object;
    /**
     * 
...
/**
 * Check if a given object implements the AllauthClientV1AccountAuthenticatorsWebauthnPostRequest interface.
 */
export function instanceOfAllauthClientV1AccountAuthenticatorsWebauthnPostRequest(value: object): value is AllauthClientV1AccountAuthenticatorsWebauthnPostRequest {
    if (!('credential' in value) || value['credential'] === undefined) return false;
    return true;
}

export function AllauthClientV1AccountAuthenticatorsWebauthnPostRequestFromJSON(json: any): AllauthClientV1AccountAuthenticatorsWebauthnPostRequest {
    return AllauthClientV1AccountAuthenticatorsWebauthnPostRequestFromJSONTyped(json, false);
}

export function AllauthClientV1AccountAuthenticatorsWebauthnPostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AllauthClientV1AccountAuthenticatorsWebauthnPostRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function AllauthClientV1AccountAuthenticatorsWebauthnPostRequestToJSON(json: any): AllauthClientV1AccountAuthenticatorsWebauthnPostRequest {
    return AllauthClientV1AccountAuthenticatorsWebauthnPostRequestToJSONTyped(json, false);
}

export function AllauthClientV1AccountAuthenticatorsWebauthnPostRequestToJSONTyped(value?: AllauthClientV1AccountAuthenticatorsWebauthnPostRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
