...
export function instanceOfTOTPAuthenticator(value: object): value is TOTPAuthenticator {
    ...
    if (value['type'] !== 'totp') return false;
...
export function TOTPAuthenticatorToJSON(json: any): TOTPAuthenticator {
    return TOTPAuthenticatorToJSONTyped(json, false);
}

export function TOTPAuthenticatorToJSONTyped(value?: TOTPAuthenticator | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
