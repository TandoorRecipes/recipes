...
import {
    ...
    EmailVerificationInfoMetaToJSONTyped,
...
import {
    ...
    EmailVerificationInfoDataToJSONTyped,
...
export function EmailVerificationInfoToJSON(json: any): EmailVerificationInfo {
    return EmailVerificationInfoToJSONTyped(json, false);
}

export function EmailVerificationInfoToJSONTyped(value?: EmailVerificationInfo | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
