...
export function VerifyEmailToJSON(json: any): VerifyEmail {
    return VerifyEmailToJSONTyped(json, false);
}

export function VerifyEmailToJSONTyped(value?: VerifyEmail | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
