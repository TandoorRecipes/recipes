...
export function instanceOfUserSessionsConfiguration(value: object): value is UserSessionsConfiguration {
    if ((!('trackActivity' in (value as Record<string, any>)) && !('track_activity' in (value as Record<string, any>))) || ((value as Record<string, any>)['trackActivity'] === undefined && (value as Record<string, any>)['track_activity'] === undefined)) return false;
    return true;
}
...
export function UserSessionsConfigurationToJSON(json: any): UserSessionsConfiguration {
    return UserSessionsConfigurationToJSONTyped(json, false);
}

export function UserSessionsConfigurationToJSONTyped(value?: UserSessionsConfiguration | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
