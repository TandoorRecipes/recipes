...
export function EmailAddressToJSON(json: any): EmailAddress {
    return EmailAddressToJSONTyped(json, false);
}

export function EmailAddressToJSONTyped(value?: EmailAddress | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
