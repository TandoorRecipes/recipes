...
export function instanceOfStatusOK(value: any): boolean {
    for (const key in StatusOK) {
        if (Object.prototype.hasOwnProperty.call(StatusOK, key)) {
            if (StatusOK[key as keyof typeof StatusOK] === value) {
                return true;
            }
        }
    }
...
export function StatusOKToJSONTyped(value: any, ignoreDiscriminator: boolean): StatusOK {
    return value as StatusOK;
}
