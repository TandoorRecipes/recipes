...
export function instanceOfMFAConfiguration(value: object): value is MFAConfiguration {
    if ((!('supportedTypes' in (value as Record<string, any>)) && !('supported_types' in (value as Record<string, any>))) || ((value as Record<string, any>)['supportedTypes'] === undefined && (value as Record<string, any>)['supported_types'] === undefined)) return false;
    return true;
}
...
export function MFAConfigurationToJSON(json: any): MFAConfiguration {
    return MFAConfigurationToJSONTyped(json, false);
}

export function MFAConfigurationToJSONTyped(value?: MFAConfiguration | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
