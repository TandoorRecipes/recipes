...
export function EmailVerificationInfoDataToJSON(json: any): EmailVerificationInfoData {
    return EmailVerificationInfoDataToJSONTyped(json, false);
}

export function EmailVerificationInfoDataToJSONTyped(value?: EmailVerificationInfoData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
