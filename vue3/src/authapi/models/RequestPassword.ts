...
export function RequestPasswordToJSON(json: any): RequestPassword {
    return RequestPasswordToJSONTyped(json, false);
}

export function RequestPasswordToJSONTyped(value?: RequestPassword | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
