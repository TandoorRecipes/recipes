...
import type { AllauthClientV1AccountAuthenticatorsTotpGet404ResponseMeta } from './AllauthClientV1AccountAuthenticatorsTotpGet404ResponseMeta';
import {
    ...
    AllauthClientV1AccountAuthenticatorsTotpGet404ResponseMetaToJSONTyped,
...
export interface AllauthClientV1AccountAuthenticatorsTotpGet404Response {
    ...
    /**
     * 
     * @type {AllauthClientV1AccountAuthenticatorsTotpGet404ResponseStatusEnum}
     * @memberof AllauthClientV1AccountAuthenticatorsTotpGet404Response
     */
...
export function AllauthClientV1AccountAuthenticatorsTotpGet404ResponseToJSON(json: any): AllauthClientV1AccountAuthenticatorsTotpGet404Response {
    return AllauthClientV1AccountAuthenticatorsTotpGet404ResponseToJSONTyped(json, false);
}

export function AllauthClientV1AccountAuthenticatorsTotpGet404ResponseToJSONTyped(value?: AllauthClientV1AccountAuthenticatorsTotpGet404Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
