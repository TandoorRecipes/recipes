...
export interface SessionGoneResponse {
    ...
    /**
     * 
     * @type {SessionGoneResponseStatusEnum}
     * @memberof SessionGoneResponse
     */
...
export function instanceOfSessionGoneResponse(value: object): value is SessionGoneResponse {
    ...
    if (value['status'] !== 410) return false;
    return true;
}
...
export function SessionGoneResponseToJSON(json: any): SessionGoneResponse {
    return SessionGoneResponseToJSONTyped(json, false);
}

export function SessionGoneResponseToJSONTyped(value?: SessionGoneResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
