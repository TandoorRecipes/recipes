...
export interface AuthenticatedByUsernameEmailLogin {
    ...
    /**
     * 
     * @type {AuthenticatedByUsernameEmailLoginMethodEnum}
     * @memberof AuthenticatedByUsernameEmailLogin
     */
...
export function instanceOfAuthenticatedByUsernameEmailLogin(value: object): value is AuthenticatedByUsernameEmailLogin {
    ...
    if (value['method'] !== 'password') return false;
...
export function AuthenticatedByUsernameEmailLoginToJSON(json: any): AuthenticatedByUsernameEmailLogin {
    return AuthenticatedByUsernameEmailLoginToJSONTyped(json, false);
}

export function AuthenticatedByUsernameEmailLoginToJSONTyped(value?: AuthenticatedByUsernameEmailLogin | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
