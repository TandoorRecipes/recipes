...
export function ProviderAccountToJSON(json: any): ProviderAccount {
    return ProviderAccountToJSONTyped(json, false);
}

export function ProviderAccountToJSONTyped(value?: ProviderAccount | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
