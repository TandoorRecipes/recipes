...
export function instanceOfUser(value: object): value is User {
    ...
    if ((!('hasUsablePassword' in (value as Record<string, any>)) && !('has_usable_password' in (value as Record<string, any>))) || ((value as Record<string, any>)['hasUsablePassword'] === undefined && (value as Record<string, any>)['has_usable_password'] === undefined)) return false;
