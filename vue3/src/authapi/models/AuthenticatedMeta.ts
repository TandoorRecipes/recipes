...
export function AuthenticatedMetaToJSON(json: any): AuthenticatedMeta {
    return AuthenticatedMetaToJSONTyped(json, false);
}

export function AuthenticatedMetaToJSONTyped(value?: AuthenticatedMeta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
