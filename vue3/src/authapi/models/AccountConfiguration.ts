...
export interface AccountConfiguration {
    ...
    /**
     * 
     * @type {Array<AccountConfigurationLoginMethodsEnum>}
     * @memberof AccountConfiguration
     */
...
export function instanceOfAccountConfiguration(value: object): value is AccountConfiguration {
    if ((!('emailVerificationByCodeEnabled' in (value as Record<string, any>)) && !('email_verification_by_code_enabled' in (value as Record<string, any>))) || ((value as Record<string, any>)['emailVerificationByCodeEnabled'] === undefined && (value as Record<string, any>)['email_verification_by_code_enabled'] === undefined)) return false;
    if ((!('isOpenForSignup' in (value as Record<string, any>)) && !('is_open_for_signup' in (value as Record<string, any>))) || ((value as Record<string, any>)['isOpenForSignup'] === undefined && (value as Record<string, any>)['is_open_for_signup'] === undefined)) return false;
    if ((!('loginByCodeEnabled' in (value as Record<string, any>)) && !('login_by_code_enabled' in (value as Record<string, any>))) || ((value as Record<string, any>)['loginByCodeEnabled'] === undefined && (value as Record<string, any>)['login_by_code_enabled'] === undefined)) return false;
    return true;
}
