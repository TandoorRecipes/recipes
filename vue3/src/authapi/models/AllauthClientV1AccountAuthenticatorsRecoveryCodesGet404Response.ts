...
export interface AllauthClientV1AccountAuthenticatorsRecoveryCodesGet404Response {
    /**
     * 
     * @type {AllauthClientV1AccountAuthenticatorsRecoveryCodesGet404ResponseStatusEnum}
...
export function AllauthClientV1AccountAuthenticatorsRecoveryCodesGet404ResponseToJSON(json: any): AllauthClientV1AccountAuthenticatorsRecoveryCodesGet404Response {
    return AllauthClientV1AccountAuthenticatorsRecoveryCodesGet404ResponseToJSONTyped(json, false);
}

export function AllauthClientV1AccountAuthenticatorsRecoveryCodesGet404ResponseToJSONTyped(value?: AllauthClientV1AccountAuthenticatorsRecoveryCodesGet404Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
