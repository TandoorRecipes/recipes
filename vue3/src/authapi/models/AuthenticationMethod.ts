...
export function AuthenticationMethodToJSON(json: any): any {
    return AuthenticationMethodToJSONTyped(json, false);
}

export function AuthenticationMethodToJSONTyped(value?: AuthenticationMethod | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
