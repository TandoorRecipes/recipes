...
export function instanceOfAuthenticationMeta(value: object): value is AuthenticationMeta {
    if ((!('isAuthenticated' in (value as Record<string, any>)) && !('is_authenticated' in (value as Record<string, any>))) || ((value as Record<string, any>)['isAuthenticated'] === undefined && (value as Record<string, any>)['is_authenticated'] === undefined)) return false;
    return true;
}
...
export function AuthenticationMetaToJSON(json: any): AuthenticationMeta {
    return AuthenticationMetaToJSONTyped(json, false);
}

export function AuthenticationMetaToJSONTyped(value?: AuthenticationMeta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
