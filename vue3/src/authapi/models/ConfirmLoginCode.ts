...
export function ConfirmLoginCodeToJSON(json: any): ConfirmLoginCode {
    return ConfirmLoginCodeToJSONTyped(json, false);
}

export function ConfirmLoginCodeToJSONTyped(value?: ConfirmLoginCode | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
