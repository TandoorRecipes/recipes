...
export interface ReAuthenticatedBy2FA {
    ...
    /**
     * 
     * @type {ReAuthenticatedBy2FAMethodEnum}
     * @memberof ReAuthenticatedBy2FA
     */
...
export function instanceOfReAuthenticatedBy2FA(value: object): value is ReAuthenticatedBy2FA {
    ...
    if (value['method'] !== 'mfa') return false;
...
export function ReAuthenticatedBy2FAToJSON(json: any): ReAuthenticatedBy2FA {
    return ReAuthenticatedBy2FAToJSONTyped(json, false);
}

export function ReAuthenticatedBy2FAToJSONTyped(value?: ReAuthenticatedBy2FA | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
