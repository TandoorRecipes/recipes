...
export function instanceOfAllauthClientV1AccountAuthenticatorsTotpGet404ResponseMeta(value: object): value is AllauthClientV1AccountAuthenticatorsTotpGet404ResponseMeta {
    ...
    if ((!('totpUrl' in (value as Record<string, any>)) && !('totp_url' in (value as Record<string, any>))) || ((value as Record<string, any>)['totpUrl'] === undefined && (value as Record<string, any>)['totp_url'] === undefined)) return false;
    return true;
}
...
export function AllauthClientV1AccountAuthenticatorsTotpGet404ResponseMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): AllauthClientV1AccountAuthenticatorsTotpGet404ResponseMeta {
    ...
    return {
        ...
        'secret': json['secret'],
        'totpUrl': json['totp_url'],
    };
}

export function AllauthClientV1AccountAuthenticatorsTotpGet404ResponseMetaToJSON(json: any): AllauthClientV1AccountAuthenticatorsTotpGet404ResponseMeta {
    return AllauthClientV1AccountAuthenticatorsTotpGet404ResponseMetaToJSONTyped(json, false);
}

export function AllauthClientV1AccountAuthenticatorsTotpGet404ResponseMetaToJSONTyped(value?: AllauthClientV1AccountAuthenticatorsTotpGet404ResponseMeta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
