 ...
 * 
 * @export
 * @interface AllauthClientV1AccountAuthenticatorsTotpGet200ResponseMeta
 */
export interface AllauthClientV1AccountAuthenticatorsTotpGet200ResponseMeta {
    /**
     * Whether or not recovery codes where generated automatically.
     * @type {boolean}
     * @memberof AllauthClientV1AccountAuthenticatorsTotpGet200ResponseMeta
     */
    recoveryCodesGenerated?: boolean;
}

/**
 * Check if a given object implements the AllauthClientV1AccountAuthenticatorsTotpGet200ResponseMeta interface.
 */
export function instanceOfAllauthClientV1AccountAuthenticatorsTotpGet200ResponseMeta(value: object): value is AllauthClientV1AccountAuthenticatorsTotpGet200ResponseMeta {
    return true;
}

export function AllauthClientV1AccountAuthenticatorsTotpGet200ResponseMetaFromJSON(json: any): AllauthClientV1AccountAuthenticatorsTotpGet200ResponseMeta {
    return AllauthClientV1AccountAuthenticatorsTotpGet200ResponseMetaFromJSONTyped(json, false);
}

export function AllauthClientV1AccountAuthenticatorsTotpGet200ResponseMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): AllauthClientV1AccountAuthenticatorsTotpGet200ResponseMeta {
    if (json == null) {
        return json;
    }
    return {
...
export function AllauthClientV1AccountAuthenticatorsTotpGet200ResponseMetaToJSON(json: any): AllauthClientV1AccountAuthenticatorsTotpGet200ResponseMeta {
    return AllauthClientV1AccountAuthenticatorsTotpGet200ResponseMetaToJSONTyped(json, false);
}

export function AllauthClientV1AccountAuthenticatorsTotpGet200ResponseMetaToJSONTyped(value?: AllauthClientV1AccountAuthenticatorsTotpGet200ResponseMeta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
