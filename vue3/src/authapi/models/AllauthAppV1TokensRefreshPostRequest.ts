 ...
 * 
 * @export
 * @interface AllauthAppV1TokensRefreshPostRequest
 */
export interface AllauthAppV1TokensRefreshPostRequest {
    /**
     * The refresh token.
     * 
     * @type {string}
     * @memberof AllauthAppV1TokensRefreshPostRequest
     */
    refreshToken: string;
}

/**
 * Check if a given object implements the AllauthAppV1TokensRefreshPostRequest interface.
 */
export function instanceOfAllauthAppV1TokensRefreshPostRequest(value: object): value is AllauthAppV1TokensRefreshPostRequest {
...
export function AllauthAppV1TokensRefreshPostRequestFromJSON(json: any): AllauthAppV1TokensRefreshPostRequest {
    return AllauthAppV1TokensRefreshPostRequestFromJSONTyped(json, false);
}

export function AllauthAppV1TokensRefreshPostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AllauthAppV1TokensRefreshPostRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function AllauthAppV1TokensRefreshPostRequestToJSON(json: any): AllauthAppV1TokensRefreshPostRequest {
    return AllauthAppV1TokensRefreshPostRequestToJSONTyped(json, false);
}

export function AllauthAppV1TokensRefreshPostRequestToJSONTyped(value?: AllauthAppV1TokensRefreshPostRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
