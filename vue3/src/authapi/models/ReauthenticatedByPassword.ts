...
export interface ReauthenticatedByPassword {
    ...
    /**
     * 
     * @type {ReauthenticatedByPasswordMethodEnum}
     * @memberof ReauthenticatedByPassword
     */
...
export function ReauthenticatedByPasswordToJSON(json: any): ReauthenticatedByPassword {
    return ReauthenticatedByPasswordToJSONTyped(json, false);
}

export function ReauthenticatedByPasswordToJSONTyped(value?: ReauthenticatedByPassword | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
