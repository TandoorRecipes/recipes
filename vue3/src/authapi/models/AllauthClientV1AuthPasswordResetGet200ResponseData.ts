...
export function AllauthClientV1AuthPasswordResetGet200ResponseDataToJSON(json: any): AllauthClientV1AuthPasswordResetGet200ResponseData {
    return AllauthClientV1AuthPasswordResetGet200ResponseDataToJSONTyped(json, false);
}

export function AllauthClientV1AuthPasswordResetGet200ResponseDataToJSONTyped(value?: AllauthClientV1AuthPasswordResetGet200ResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
