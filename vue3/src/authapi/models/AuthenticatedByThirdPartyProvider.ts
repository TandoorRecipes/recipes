...
export interface AuthenticatedByThirdPartyProvider {
    ...
    /**
     * 
     * @type {AuthenticatedByThirdPartyProviderMethodEnum}
     * @memberof AuthenticatedByThirdPartyProvider
     */
...
export function instanceOfAuthenticatedByThirdPartyProvider(value: object): value is AuthenticatedByThirdPartyProvider {
    ...
    if (value['method'] !== 'socialaccount') return false;
...
export function AuthenticatedByThirdPartyProviderToJSON(json: any): AuthenticatedByThirdPartyProvider {
    return AuthenticatedByThirdPartyProviderToJSONTyped(json, false);
}

export function AuthenticatedByThirdPartyProviderToJSONTyped(value?: AuthenticatedByThirdPartyProvider | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
