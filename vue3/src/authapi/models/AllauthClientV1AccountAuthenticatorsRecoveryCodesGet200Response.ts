...
import {
    ...
    SensitiveRecoveryCodesAuthenticatorToJSONTyped,
...
export function AllauthClientV1AccountAuthenticatorsRecoveryCodesGet200ResponseToJSON(json: any): AllauthClientV1AccountAuthenticatorsRecoveryCodesGet200Response {
    return AllauthClientV1AccountAuthenticatorsRecoveryCodesGet200ResponseToJSONTyped(json, false);
}

export function AllauthClientV1AccountAuthenticatorsRecoveryCodesGet200ResponseToJSONTyped(value?: AllauthClientV1AccountAuthenticatorsRecoveryCodesGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
