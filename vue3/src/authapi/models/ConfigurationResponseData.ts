...
import {
    ...
    UserSessionsConfigurationToJSONTyped,
...
import {
    ...
    SocialAccountConfigurationToJSONTyped,
...
export function ConfigurationResponseDataToJSON(json: any): ConfigurationResponseData {
    return ConfigurationResponseDataToJSONTyped(json, false);
}

export function ConfigurationResponseDataToJSONTyped(value?: ConfigurationResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
