...
export function instanceOfSensitiveRecoveryCodesAuthenticator(value: object): value is SensitiveRecoveryCodesAuthenticator {
    ...
    if ((!('unusedCodes' in (value as Record<string, any>)) && !('unused_codes' in (value as Record<string, any>))) || ((value as Record<string, any>)['unusedCodes'] === undefined && (value as Record<string, any>)['unused_codes'] === undefined)) return false;
    return true;
}
