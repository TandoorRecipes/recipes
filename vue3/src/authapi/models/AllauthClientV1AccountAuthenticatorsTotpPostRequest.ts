...
export function AllauthClientV1AccountAuthenticatorsTotpPostRequestToJSON(json: any): AllauthClientV1AccountAuthenticatorsTotpPostRequest {
    return AllauthClientV1AccountAuthenticatorsTotpPostRequestToJSONTyped(json, false);
}

export function AllauthClientV1AccountAuthenticatorsTotpPostRequestToJSONTyped(value?: AllauthClientV1AccountAuthenticatorsTotpPostRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
