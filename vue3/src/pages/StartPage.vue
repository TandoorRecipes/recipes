<template>
  <v-container class="home">
    <horizontal-meal-plan-window class="home__mealplan" v-if="useUserPreferenceStore().deviceSettings.start_showMealPlan"></horizontal-meal-plan-window>

    <v-card v-if="totalRecipes == 0" class="mt-5 mb-5 home__empty">
