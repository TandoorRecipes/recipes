<template>
  <!-- DEPRECATION WARNING: instead of 'step__scalable-num_scaled_{up,down,false}'  use '.scaled--{up,down,default} .step__scalable-num' -->
  <span
    class="step__scalable-num"
