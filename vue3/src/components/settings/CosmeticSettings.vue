<template>
    <v-form>
        ...
        <v-select :label="$t('Theme')" class="mt-4" v-model="useUserPreferenceStore().userSettings.theme" :items="[{title: 'Tandoor', value: 'TANDOOR'}, {title: 'Tandoor Dark', value: 'TANDOOR_DARK'}, {title: 'Dracula', value: 'TANDOOR_DRACULA'}, ]">
        </v-select>
