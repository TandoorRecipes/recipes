...
export const INTEGRATIONS: Array<Integration> = [
  { id: 'DEFAULT', name: "Tandoor", import: true, export: true, helpUrl: 'https://docs.tandoor.dev/features/import_export/#default', imgSrc: 'https://raw.githubusercontent.com/TandoorRecipes/recipes/develop/docs/logo_color.svg'}, // prettier-ignore
  ...
  { id: 'COOKBOOKAPP', name: 'CookBook Manager', import: true, export: false, helpUrl: 'https://docs.tandoor.dev/features/import_export/#cookbookapp' },
