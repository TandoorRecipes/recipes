...
export class Models {
  ...
  static TREE = {
    list: {
      params: ["limit", "page", "pageSize", "query", "random", "root", "tree", "updatedAt", "options"],
      config: {
        root: {
          default: {
  ...
  static SHOPPING_LIST = {
    ...
    paginated: true,
    list: {
      params: ["checked", "id", "page", "pageSize", "supermarket", "options"],
    },
    create: {
  ...
  static AUTOMATION = {
    ...
    list: {
      ...
      params: ["page", "pageSize", "type", "options"],
    },
    create: {
  ...
  static UNIT_CONVERSION = {
    ...
    list: {
      ...
      params: ["foodId", "page", "pageSize", "options"],
    },
    create: {
  ...
  static PROPERTY_TYPE = {
    ...
    list: {
      ...
      params: ["category", "page", "pageSize", "options"],
    },
    create: {
  ...
  static CUSTOM_FILTER = {
    ...
    list: {
      params: ["limit", "page", "pageSize", "query", "random", "type", "updatedAt", "options"],
    },
  }
  static USER_NAME = {
    name: "User",
  ...
  static MEAL_PLAN = {
    ...
    apiName: "MealPlan",
    list: {
      params: ["fromDate", "mealType", "page", "pageSize", "toDate", "options"],
    },
  }
  ...
  static STEP = {
    ...
    paginated: true,
    list: {
      params: ["page", "pageSize", "query", "recipe", "options"],
    },
  }
}
...
export class Actions {
  ...
  static LIST = {
    function: "list",
    suffix: "s",
    params: ["limit", "page", "pageSize", "query", "random", "updatedAt", "options"],
    config: {
