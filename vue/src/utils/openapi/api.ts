...
export const ApiApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        flatRecipe: async (options: any = {}): Promise<RequestArgs> => {
...
export const ApiApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async flatRecipe(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RecipeFlat>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.flatRecipe(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const ApiApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        flatRecipe(options?: any): AxiosPromise<RecipeFlat> {
            return localVarFp.flatRecipe(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id A unique integer value identifying this recipe.
...
export class ApiApi extends BaseAPI {
     ...
     * @memberof ApiApi
     */
    public flatRecipe(options?: any) {
        return ApiApiFp(this.configuration).flatRecipe(options).then((request) => request(this.axios, this.basePath));
    }
