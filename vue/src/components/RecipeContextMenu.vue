  ...
  <div>
    <div class="dropdown d-print-none">
      ...
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
        <a class="dropdown-item" :href="resolveDjangoUrl('edit_recipe', recipe.id)" v-if="!disabled_options.edit"><i class="fas fa-pencil-alt fa-fw"></i> {{ $t("Edit") }}</a>
        ...
        <a class="dropdown-item" @click="addToWishlist" href="javascript:void(0);"> <i class="fas fa-heart fa-fw"></i> {{ $t("Add_to_Wishlist") }} </a>
...
export default {
  ...
  methods: {
    ...
    addToWishlist() {
      const recipeId = this.recipe.id // Assuming this.recipe contains the current recipe
      ...
      apiClient
        ...
        .catch((error) => {
          StandardToasts.makeStandardToast(this, StandardToasts.FAIL_CREATE, error)
        })
    },
    createMealPlan(data) {
