        ...
        <b-modal :id="id" size="xl" @hidden="cancelAction" :body-class="`pr-3 pl-3`">
            <template v-slot:modal-title>
                <div class="row" v-if="food">
                    <div class="col-12">
                        <h2>
                            {{ food.name }} <small class="text-muted" v-if="food.plural_name">{{ food.plural_name }}</small>
                        </h2>
                    </div>
                </div>
            </template>
                    ...
                    <b-tab title="General" active>
                        <b-form>
                            ...
                            <b-form-group :label="$t('Description')" description="">
                                <b-form-input v-model="food.description"></b-form-input>
                            </b-form-group>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr v-for="fp in food.properties" v-bind:key="fp.id">
                                    <td>
                                        <input v-model="fp.property_amount" type="number" /> <span v-if="fp.property_type">{{ fp.property_type.unit }}</span>
                                    </td>
                                    <td>
                                        <generic-multiselect
                                    ...
                                    <td>
                                        /
                                        <span
                                            >{{ food.properties_food_amount }} <span v-if="food.properties_food_unit !== null">{{ food.properties_food_unit.name }}</span></span
                                        >
                                    </td>
                                    <td>
                                        <a class="btn btn-danger btn-small" @click="deleteProperty(fp)"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div class="text-center">
                                <b-button-group>
                                    <b-btn class="btn btn-success shadow-none" @click="addProperty()"><i class="fa fa-plus"></i> </b-btn>
                                    <b-btn class="btn btn-secondary shadow-none" @click="addAllProperties()"
                                        ><i class="fa fa-plus"> <i class="ml-1 fas fa-list"></i></i>
                                    </b-btn>
                                </b-button-group>
                            </div>
    ...
    methods: {
        updateFood: function () {
            ...
            if (this.food.id !== undefined) {
                apiClient
                    .updateFood(this.food.id, this.food)
                    .then((r) => {
                        this.food = r.data
