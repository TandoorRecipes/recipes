...
export default {
    ...
    methods: {
        ...
        hasDuplicateFilter(type, count) {
            ...
            return (type.filter(x => x.operator === true && x.not === true).length > 1) || (type.filter(x => x.operator === true && x.not === false).length > 1) || (type.filter(x => x.operator === false && x.not === true).length > 1) || (type.filter(x => x.operator === false && x.not === false).length > 1)
        },
    },
}
</script>
