...
Given(
  "the superuser has created a space named {string}",
...
When(
  "the superuser creates new recipe {string} with following details:",
  async function (recipeName, recipeDetails) {
...
When(
  "the superuser adds following ingredients",
...
Then(
  "the superuser should be redirected to the {string} recipe page",
