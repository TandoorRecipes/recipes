...
export class ApiApi extends runtime.BaseAPI {
    ...
    async apiAutoPlanCreateRaw(requestParameters: ApiAutoPlanCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AutoMealPlan>> {
        if (requestParameters.autoMealPlan === null || requestParameters.autoMealPlan === undefined) {
            throw new runtime.RequiredError('autoMealPlan','Required parameter requestParameters.autoMealPlan was null or undefined when calling apiAutoPlanCreate.');
        }
    ...
    async apiFoodShoppingUpdateRaw(requestParameters: ApiFoodShoppingUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FoodShoppingUpdate>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling apiFoodShoppingUpdate.');
        }

        if (requestParameters.foodShoppingUpdate === null || requestParameters.foodShoppingUpdate === undefined) {
            throw new runtime.RequiredError('foodShoppingUpdate','Required parameter requestParameters.foodShoppingUpdate was null or undefined when calling apiFoodShoppingUpdate.');
        }
    ...
    async apiPlanIcalRetrieveRaw(requestParameters: ApiPlanIcalRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.fromDate === null || requestParameters.fromDate === undefined) {
            throw new runtime.RequiredError('fromDate','Required parameter requestParameters.fromDate was null or undefined when calling apiPlanIcalRetrieve.');
        }

        if (requestParameters.toDate === null || requestParameters.toDate === undefined) {
            throw new runtime.RequiredError('toDate','Required parameter requestParameters.toDate was null or undefined when calling apiPlanIcalRetrieve.');
        }
    ...
    async apiUserListRaw(requestParameters: ApiUserListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<User>>> {
        ...
        if (requestParameters.filterList !== undefined) {
