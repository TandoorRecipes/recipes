...
class IngredientSimpleSerializer(WritableNestedModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            'is_header', 'no_amount', 'properties_consumed_fraction', 'original_text', 'checked',
        )
...
class IngredientSerializer(IngredientSimpleSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            'is_header', 'no_amount', 'properties_consumed_fraction', 'original_text', 'used_in_recipes', 'checked',
        )
...
class AutoMealPlanSerializer(serializers.Serializer):
    ...
    keywords = serializers.ListField(child=serializers.IntegerField(), required=False, default=[])
    keyword_mode = serializers.ChoiceField(choices=['or', 'and'], default='and')
    servings = CustomDecimalField()
...
class IngredientExportSerializer(WritableNestedModelSerializer):
    ...
    class Meta:
        model = Ingredient
        fields = ('food', 'unit', 'amount', 'note', 'order', 'is_header', 'no_amount', 'properties_consumed_fraction')
