...
class Cooklang(Integration):
    ...
    def get_recipe_from_file(self, file):
        ...
        recipe = Recipe.objects.create(
            name=recipe_json['name'].strip(), description=description, created_by=self.request.user, internal=True, servings=recipe_json['recipeYield'], space=self.request.space
        )
