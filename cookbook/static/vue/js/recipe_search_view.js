...
/* harmony default export */ var RecipeSearchViewvue_type_script_lang_js_ = ({
      ...
      if (urlParams.has('keyword')) {
        ...
        try {
          var _loop = function _loop() {
            ...
            _this.settings.search_keywords.push(Number.parseInt(keyword.id));
  ...
  methods: {
    refreshData: function refreshData(random) {
      ...
      var apiClient = new api["a" /* ApiApiFactory */]();
      apiClient.listRecipes(this.settings.search_input, this.settings.search_keywords, this.settings.search_foods, undefined, this.settings.search_books.map(function (A) {
        return A["id"];
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  RecipeSearchViewvue_type_template_id_3fa5f6b4_render,
  staticRenderFns,
  false,
  null,
  null,
