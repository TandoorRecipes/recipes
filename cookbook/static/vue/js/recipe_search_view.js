...
/* harmony default export */ var RecipeSearchViewvue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    this.$nextTick(function () {
      ...
      if (urlParams.has('keyword')) {
        ...
        try {
          var _loop = function _loop() {
            ...
            _this.settings.search_keywords.push(keyword.id);
      ...
      this.loadMealPlan(); // this.loadRecentlyViewed()
  ...
  methods: {
    refreshData: function refreshData(random) {
      ...
      apiClient.listRecipes(this.settings.search_input, this.settings.search_keywords, this.settings.search_foods, this.settings.search_books.map(function (A) {
        return A["id"];
      }), this.settings.search_keywords_or, this.settings.search_foods_or, this.settings.search_books_or, this.settings.search_internal, random, this.settings.sort_by_new, this.settings.pagination_page, this.settings.page_count, {
        query: {
        ...
        _this2.recipes = _this2.removeDuplicates(result.data.results, function (recipe) {
          return recipe.id;
        });
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  RecipeSearchViewvue_type_template_id_7c80abb6_render,
  staticRenderFns,
  false,
  null,
  null,
