...
module.exports = __webpack_require__("6631");
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/apps/KeywordListView/KeywordListView.vue?vue&type=script&lang=js&
...
/* harmony default export */ var KeywordListViewvue_type_script_lang_js_ = ({
  name: 'KeywordListView',
  mixins: [utils["f" /* ToastMixin */]],
  components: {
  ...
  methods: {
    ...
    saveKeyword: function saveKeyword() {
      ...
      if (!this.this_item.id) {
        ...
        apiClient.createKeyword(kw).then(function (result) {
          // place all new keywords at the top of the list - could sort instead
          _this.keywords = [result.data].concat(_this.keywords); // this creates a deep copy to make sure that columns stay independent

          if (_this.show_split) {
            _this.keywords2 = [JSON.parse(JSON.stringify(result.data))].concat(_this.keywords2);
          } else {
            _this.keywords2 = [];
          }
        ...
        apiClient.partialUpdateKeyword(this.this_item.id, kw).then(function (result) {
    ...
    delKeyword: function delKeyword(id) {
      var _this2 = this;

      var apiClient = new api["a" /* ApiApiFactory */]();
      apiClient.destroyKeyword(id).then(function (response) {
    ...
    moveKeyword: function moveKeyword(source_id, target_id) {
      var _this3 = this;

      var apiClient = new api["a" /* ApiApiFactory */]();
      apiClient.moveKeyword(String(source_id), String(target_id)).then(function (result) {
        if (target_id === 0) {
          var kw = _this3.findKeyword(_this3.keywords, source_id) || _this3.findKeyword(_this3.keywords2, source_id);
          ...
          if (_this3.show_split) {
            ...
            _this3.keywords = [kw].concat(_this3.keywords);
            _this3.keywords2 = [JSON.parse(JSON.stringify(kw))].concat(_this3.keywords2);
          } else {
    ...
    mergeKeyword: function mergeKeyword(source_id, target_id) {
      var _this4 = this;

      var apiClient = new api["a" /* ApiApiFactory */]();
      apiClient.mergeKeyword(String(source_id), String(target_id)).then(function (result) {
    ...
    getChildren: function getChildren(col, kw) {
      var _this5 = this;
      ...
      var tree = undefined;
      var pageSize = 200;
      apiClient.listKeywords(query, root, tree, page, pageSize).then(function (result) {
        if (col == 'left') {
          parent = _this5.findKeyword(_this5.keywords, kw.id);
        } else if (col == 'right') {
          parent = _this5.findKeyword(_this5.keywords2, kw.id);
        }
    ...
    getRecipes: function getRecipes(col, kw) {
      var _this6 = this;

      var apiClient = new api["a" /* ApiApiFactory */]();
      var parent = {};
      var pageSize = 200;
      var keyword = String(kw.id);
      apiClient.listRecipes(undefined, keyword, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, pageSize, undefined).then(function (result) {
        if (col == 'left') {
          parent = _this6.findKeyword(_this6.keywords, kw.id);
        } else if (col == 'right') {
          parent = _this6.findKeyword(_this6.keywords2, kw.id);
        }
    ...
    refreshCard: function refreshCard(id) {
      ...
      var idx = undefined;
      var idx2 = undefined;
      apiClient.retrieveKeyword(id).then(function (result) {
        target = _this7.findKeyword(_this7.keywords, id) || _this7.findKeyword(_this7.keywords2, id);

        if (target.parent) {
          var parent = _this7.findKeyword(_this7.keywords, target.parent);

          var parent2 = _this7.findKeyword(_this7.keywords2, target.parent);
          ...
          idx = _this7.keywords.indexOf(_this7.keywords.find(function (kw) {
            return kw.id === target.id;
          }));
          idx2 = _this7.keywords2.indexOf(_this7.keywords2.find(function (kw) {
            return kw.id === target.id;
          }));
          vue_esm["default"].set(_this7.keywords, idx, result.data);
          vue_esm["default"].set(_this7.keywords2, idx2, JSON.parse(JSON.stringify(result.data)));
        }
      });
    },
    findKeyword: function findKeyword(card_list, id) {
    ...
    infiniteHandler: function infiniteHandler($state, col) {
      ...
      apiClient.listKeywords(query, root, tree, page, pageSize).then(function (result) {
        if (result.data.results.length) {
          if (col === 'left') {
            _this8.left_page += 1;
            _this8.keywords = _this8.keywords.concat(result.data.results);
            $state.loaded();

            if (_this8.keywords.length >= result.data.count) {
              $state.complete();
            }
          } else if (col === 'right') {
            _this8.right_page += 1;
            _this8.keywords2 = _this8.keywords2.concat(result.data.results);
            $state.loaded();

            if (_this8.keywords2.length >= result.data.count) {
              $state.complete();
            }
          }
        } else {
    ...
    destroyCard: function destroyCard(id) {
      ...
      var kw = this.findKeyword(this.keywords, id);
      var kw2 = this.findKeyword(this.keywords2, id);
      var p_id = undefined;
      p_id = (_kw$parent = kw === null || kw === void 0 ? void 0 : kw.parent) !== null && _kw$parent !== void 0 ? _kw$parent : kw2.parent;

      if (p_id) {
        var parent = this.findKeyword(this.keywords, p_id);
        var parent2 = this.findKeyword(this.keywords2, p_id);
      ...
      this.keywords = this.keywords.filter(function (kw) {
        return kw.id != id;
      });
      this.keywords2 = this.keywords2.filter(function (kw) {
        return kw.id != id;
      });
    }
  }
});
// CONCATENATED MODULE: ./src/apps/KeywordListView/KeywordListView.vue?vue&type=script&lang=js&
 /* harmony default export */ var KeywordListView_KeywordListViewvue_type_script_lang_js_ = (KeywordListViewvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./src/apps/KeywordListView/KeywordListView.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  KeywordListView_KeywordListViewvue_type_script_lang_js_,
  KeywordListViewvue_type_template_id_7996aa64_render,
  staticRenderFns,
  false,
  null,
  null,
...
/* harmony default export */ var KeywordListView = (component.exports);
// EXTERNAL MODULE: ./src/i18n.js
var i18n = __webpack_require__("9225");

// CONCATENATED MODULE: ./src/apps/KeywordListView/main.js
