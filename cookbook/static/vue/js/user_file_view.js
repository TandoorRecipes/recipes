  ...
  methods: {
    ...
    updateFile: function updateFile() {
      ...
      apiClient.updateUserFile(this.file.id, this.file.name, passedFile).then(function (request) {
        Object(utils["j" /* makeToast */])(_this2.$t('Success'), _this2.$t('success_updating_resource'), 'success');

        _this2.$emit('change');
      }).catch(function (err) {
        Object(utils["j" /* makeToast */])(_this2.$t('Error'), _this2.$t('err_updating_resource') + '\n' + err.response.data, 'danger');
    ...
    createFile: function createFile() {
      ...
      apiClient.createUserFile(this.file.name, this.file.file).then(function (request) {
        Object(utils["j" /* makeToast */])(_this3.$t('Success'), _this3.$t('success_creating_resource'), 'success');
        ...
        Object(utils["j" /* makeToast */])(_this3.$t('Error'), _this3.$t('err_creating_resource') + '\n' + err.response.data, 'danger');
        console.log(err.request, err.response);
      });
    },
    deleteFile: function deleteFile() {
      ...
      apiClient.destroyUserFile(this.file.id).then(function (results) {
        Object(utils["j" /* makeToast */])(_this4.$t('Success'), _this4.$t('success_deleting_resource'), 'success');

        _this4.$emit('change');
      }).catch(function (err) {
        Object(utils["j" /* makeToast */])(_this4.$t('Error'), _this4.$t('err_deleting_resource') + '\n' + err.response.data, 'danger');
        console.log(err.request, err.response);
      });
    }
  }
