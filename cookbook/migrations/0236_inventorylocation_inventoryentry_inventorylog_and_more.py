    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires_frozen', models.DateField(blank=True, null=True)),
                ...
                ('storage_location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cookbook.inventorylocation')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_storage_location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='new_storage_location', to='cookbook.inventorylocation')),
                ('old_storage_location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='old_storage_location', to='cookbook.inventorylocation')),
                ('space', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cookbook.space')),
            ],
            bases=(models.Model, cookbook.models.PermissionModelMixin),
        ),
